...
const Welcome = (props: Props) => {
  return (
    <section className='px-[--root-margin] py-[34px] flex items-center justify-between relative'>
      <div>
        <div
          className={`px-[10px] py-[17px] w-fit text-primary bg-primary_light text-[14px] font-[500] rounded-[5px]`}>
          WORKING TOGETHER WITH MEDICINE
        </div>
        <div
          className={`w-[459px] mt-[12px] mb-[20px] text-[36px] font-[600] leading-[120%]`}>
          Enabling Worldwide Access to Personalized Precision{' '}
          <span className={`text-primary`}>Medicine.</span>
        </div>
        <div className={`mb-[32px] w-[414px] text-gray_1 text-[18px]`}>
